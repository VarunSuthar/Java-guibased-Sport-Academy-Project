...
public class loginpage extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Eklavya Sport Academy - Login Page");

        jLabel1.setFont(new java.awt.Font("Segoe UI", 1, 45)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(153, 0, 153));
        jLabel1.setText("Eklavya Sports Academy");
        ...
        utxt.setFont(new java.awt.Font("Segoe UI", 0, 22)); // NOI18N
        ...
        ptxt.setFont(new java.awt.Font("Segoe UI", 0, 18)); // NOI18N
        ...
        jPanel1Layout.setHorizontalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(utxt)
                    .addComponent(ptxt, javax.swing.GroupLayout.DEFAULT_SIZE, 266, Short.MAX_VALUE))
   ...
   try
   {
       ...
       c=DriverManager.getConnection("jdbc:mysql://localhost/linda","root","");
       s=c.createStatement();
       String a=utxt.getText();
       String b=ptxt.getText();
       rs=s.executeQuery("select username,password from login");
       while(rs.next())
       {       //flag=1;
       ...
       this.setVisible(false);   new registration_page().setVisible(true);
         //continue;
         break;
         }
       ...
       {
           JOptionPane.showMessageDialog(this,"Please Enter valid Password and Username");
           break;
